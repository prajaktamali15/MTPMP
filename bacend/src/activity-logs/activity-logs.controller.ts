...
export class ActivityLogsController {
  ...
  async getActivityLogsByProjectId(@Param('projectId') projectId: string, @Req() req: RequestWithUser) {
  ...
  @Get('task/:taskId')
  async getActivityLogsByTaskId(@Param('taskId') taskId: string, @Req() req: RequestWithUser) {
  ...
  @Get(':id')
  async getActivityLogById(@Param('id') id: string, @Req() req: RequestWithUser) {
